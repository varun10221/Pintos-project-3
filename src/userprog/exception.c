...
page_fault (struct intr_frame *f) 
{
  ...
  /* Page fault in the kernel while getting syscall args. 
   
     Two possibilities:
      1. The stack page containing those args is paged out (valid)
      2. Invalid syscall args (including "stack growth") (invalid)
  ...
  {
    /* If this is not a valid stack access, return in error. */
